...
const Item = ({icon, name, badge, url}:ItemProps) => {
    ...
    return (
        <Link  href={url} passHref>
            <div onClick={() => setCollapse(true)} className="relative w-full font-medium cursor-pointer transition-all duration-400 ease-in-out flex justify-between items-center rounded-xl px-5 py-3 text-unity-gray hover:bg-unity-purple hover:text-white">
